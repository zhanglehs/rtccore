...
const float kDefaultDropRatioMax = 0.96f;   // this means the minimum fps is _incoming_frame_rate*(1-0.96f)
//const float kDefaultMaxTimeToDropFrames = 4.0f;  // In seconds.
const float kDefaultMaxTimeToDropFrames = 0.5f;  // In seconds.  // it means the minimum fps is 1/0.5f=2
