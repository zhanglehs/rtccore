...
const CodecInst ACMCodecDB::database_[] = {
  ...
  {103, "ISAC", 16000, kIsacPacSize480, 1, kIsacWbDefaultRate,0,0,0,""},
# if (defined(WEBRTC_CODEC_ISAC))
  { 104, "ISAC", 32000, kIsacPacSize960, 1, kIsacSwbDefaultRate, 0, 0, 0, "" },
  { 105, "ISAC", 48000, kIsacPacSize1440, 1, kIsacSwbDefaultRate, 0, 0, 0, "" },
# endif
#endif
#ifdef WEBRTC_CODEC_PCM16
  // Mono
  { 107, "L16", 8000, 80, 1, 128000, 0, 0, 0, "" },
  { 108, "L16", 16000, 160, 1, 256000, 0, 0, 0, "" },
  { 109, "L16", 32000, 320, 1, 512000, 0, 0, 0, "" },
  // Stereo
  { 111, "L16", 8000, 80, 2, 128000, 0, 0, 0, "" },
  { 112, "L16", 16000, 160, 2, 256000, 0, 0, 0, "" },
  { 113, "L16", 32000, 320, 2, 512000, 0, 0, 0, "" },
#endif
  // G.711, PCM mu-law and A-law.
  // Mono
  { 0, "PCMU", 8000, 160, 1, 64000, 0, 0, 0, "" },
  { 8, "PCMA", 8000, 160, 1, 64000, 0, 0, 0, "" },
  // Stereo
  { 110, "PCMU", 8000, 160, 2, 64000, 0, 0, 0, "" },
  { 118, "PCMA", 8000, 160, 2, 64000, 0, 0, 0, "" },
#ifdef WEBRTC_CODEC_ILBC
  { 102, "ILBC", 8000, 240, 1, 13300, 0, 0, 0, "" },
#endif
#ifdef WEBRTC_CODEC_G722
  // Mono
  { 9, "G722", 16000, 320, 1, 64000, 0, 0, 0, "" },
  // Stereo
  { 119, "G722", 16000, 320, 2, 64000, 0, 0, 0, "" },
#endif
#ifdef WEBRTC_CODEC_OPUS
  // Opus internally supports 48, 24, 16, 12, 8 kHz.
  // Mono and stereo.
  { 120, "opus", 48000, 960, 2, 64000, 0, 0, 0, "" },
#endif

  { 97, "aac1", 48000, 2048, 2, 24000, 0, 0, 0, "" },//pltype;plname;plfreq;pacsize;channels;rate;

  // Comfort noise for four different sampling frequencies.
  { 13, "CN", 8000, 240, 1, 0, 0, 0, 0, "" },
  { 98, "CN", 16000, 480, 1, 0, 0, 0, 0, "" },
  { 99, "CN", 32000, 960, 1, 0, 0, 0, 0, "" },
#ifdef ENABLE_48000_HZ
  {100, "CN", 48000, 1440, 1, 0,0,0,0,""},
#endif
#ifdef WEBRTC_CODEC_AVT
  { 106, "telephone-event", 8000, 240, 1, 0, 0, 0, 0, "" },
#endif
#ifdef WEBRTC_CODEC_RED
  { 127, "red", 8000, 0, 1, 0, 0, 0, 0, "" },
#endif
  // To prevent compile errors due to trailing commas.
  { -1, "Null", -1, -1, -1, -1, 0, 0, 0, "" }
};
...
# endif
	...
	{ 4, { 1024, 2048, 4096, 6144 }, 0, 2, false },
	{ 4, { 1024, 2048, 4096, 6144 }, 0, 2, false },//num_packet_sizes;packet_sizes_samples;basic_block_samples;channel_support;owns_decoder;
...
ACMGenericCodec* ACMCodecDB::CreateCodecInstance(const CodecInst& codec_inst,
  ...
  else if (!STR_CASE_CMP(codec_inst.plname, "aac1")) {
