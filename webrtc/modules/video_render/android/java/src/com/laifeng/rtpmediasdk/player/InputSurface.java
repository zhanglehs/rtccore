...
public class InputSurface {
	private static final String TAG = "webrtc_surface";
	...
	public int getWidth() {
		mSize[0] = 0;
		EGL14.eglQuerySurface(mEGLDisplay, mEGLSurface, EGL14.EGL_WIDTH, mSize, 0);
		return mSize[0];
	}

	public int getHeight() {
		mSize[0] = 0;
		EGL14.eglQuerySurface(mEGLDisplay, mEGLSurface, EGL14.EGL_HEIGHT, mSize, 0);
		return mSize[0];
	}
